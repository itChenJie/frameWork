...
//    private final String moduleName ="logistics_db";
    ...
    // 对应模块名称（根据自己模块做相应调整!!!务必修改^_^）
    private final String bean_path = "./opt/entity";

    private final String mapper_path = "./opt/mapper";

    private final String xml_path = "./opt/xml";

    private final String bean_package ;

    private final String mapper_package ;
    ...
    public static void main(String[] args) throws RuntimeException {
        try {
            List<String> tables = new ArrayList<String>();
            tables.add("72crm_admin_attendance_address");
            new EntityUtil("crm_online","com.chengsi.external.logistics.wl.model","com.chengsi.external.logistics.wl.repository"
            ,"com.mysql.jdbc.Driver","root","root","jdbc:mysql://127.0.0.1:3306/crm_online?characterEncoding=utf8").generate(tables);
            // 自动打开生成文件的目录
