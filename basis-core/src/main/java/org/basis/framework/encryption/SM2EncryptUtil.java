...
public class SM2EncryptUtil {
    ...
    public static KeyPair createECKeyPair(){
        return createKeyPair("EC","sm2p256v1");
    }
     ...
     * @return KeyPair 密钥对
     */
    public static KeyPair createKeyPair(String algorithm,String stdName) {
        //名称参数规范
        final ECGenParameterSpec sm2Spec = new ECGenParameterSpec(stdName);
        final KeyPairGenerator kpg;
        try {
            kpg = KeyPairGenerator.getInstance(algorithm, new BouncyCastleProvider());
